...
public class Notebook
{
    ...
    /// <summary>True if the title was auto-generated by AI.</summary>
    public bool AutoTitled { get; set; }
    /// <summary>Path to the .fink file for this notebook.</summary>
    public string FinkFilePath { get; set; } = string.Empty;
    /// <summary>PDF background path (if imported from PDF).</summary>
    public string? PdfSourcePath { get; set; }
    /// <summary>AI-generated auto-title for this notebook.</summary>
